# AnimShape  [![npm version](https://d25lcipzij17d.cloudfront.net/badge.svg?id=js&type=6&v=1.1.1&x2=0)](https://www.npmjs.com/package/art-anim-shape)
...
export default class MyBezier extends Component {
  render() {
    return (
     ...
     time= {3000} stroke='red' strokeWidth={4} isRepeat={true}/>
     </ART.Surface>
      </View>
    );
  }
